...
class _JsonReadingAndWritingState extends State<JsonReadingAndWriting> {
  ...
  Person _person = new Person(occupation: '', firstName: '', id: '', lastName: '');
  ...
  void _prepareAddPerson() {
    setState(() {
      ...
      _person = new Person(occupation: '', firstName: '', id: '', lastName: '');
    });
  }
...
class Person {
  ...
  Person({required this.id, required this.firstName, required this.lastName, required this.occupation});
